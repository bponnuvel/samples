...
using SimpleService.IntegrationEvents.EventHandlers;
...
namespace SimpleService
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IEventBus, EventBusRabbitMQ.EventBusRabbitMQ>(sp =>
            {
                ...
                return new EventBusRabbitMQ.EventBusRabbitMQ(rabbitMQPersistentConnection, logger, iLifetimeScope,
                    eventBusSubcriptionsManager, "SimpleService", retryCount);
            });

            services.AddSingleton<IEventBusSubscriptionsManager, InMemoryEventBusSubscriptionsManager>();
            services.AddTransient<BookAddedIntegrationEventHandler>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            eventBus.Subscribe<BookAddedIntegrationEvent,
                BookAddedIntegrationEventHandler>();
